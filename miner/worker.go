...
import (
	...
	"github.com/yonggewang/BDLShain/consensus/bdls_engine"
	"github.com/yonggewang/BDLShain/consensus/misc"
...
func newWorker(config *Config, chainConfig *params.ChainConfig, engine consensus.Engine, eth Backend, mux *event.TypeMux, isLocalBlock func(*types.Block) bool, init bool) *worker {
	...
	// BDLS: set BDLS specific block validator
...
func (w *worker) newWorkLoop(recommit time.Duration) {
	...
	for {
		...
		case <-timer.C:
			...
			if w.isRunning() && (w.chainConfig.Clique == nil || w.chainConfig.Clique.Period > 0) && w.chainConfig.BDLS == nil {
