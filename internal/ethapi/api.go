...
import (
	...
	"github.com/yonggewang/BDLSChain/accounts/scwallet"
...
//
// https://github.com/yonggewang/BDLSChain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/yonggewang/BDLSChain/wiki/Management-APIs#personal_ecRecover
...
func RPCMarshalHeader(head *types.Header) map[string]interface{} {
	return map[string]interface{}{
		...
		"decision":         hexutil.Bytes(head.Decision),
