...
import (
	...
	"github.com/yonggewang/BDLSChain/consensus/clique"
	...
	"github.com/yonggewang/BDLSChain/eth/gasprice"
	"github.com/yonggewang/BDLSChain/ethdb"
	"github.com/yonggewang/BDLSChain/ethstats"
	"github.com/yonggewang/BDLSChain/graphql"
	"github.com/yonggewang/BDLSChain/les"
	"github.com/yonggewang/BDLSChain/log"
	"github.com/yonggewang/BDLSChain/metrics"
	"github.com/yonggewang/BDLSChain/metrics/influxdb"
	...
	"github.com/yonggewang/BDLSChain/p2p/nat"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 5889=Mainnet, 5890=Testnet)",
		Value: eth.DefaultConfig.NetworkId,
	}
	TestnetFlag = cli.BoolFlag{
		Name:  "testnet",
		Usage: "test network: pre-configured BDLS test network",
	}
	...
	// BDLS: staking command
	BDLSStakeFromFlag = cli.IntFlag{
		Name:  "stake.from",
		Usage: "the beginning block number to become a validator node",
	}

	BDLSStakeToFlag = cli.IntFlag{
		Name:  "stake.to",
