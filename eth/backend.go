...
import (
	...
	"github.com/yonggewang/BDLChain/consensus/bdls_engine"
	...
	"github.com/yonggewang/BDLChain/core/bloombits"
	...
	"github.com/yonggewang/BDLChain/eth/filters"
...
func CreateConsensusEngine(ctx *node.ServiceContext, chainConfig *params.ChainConfig, config *ethash.Config, notify []string, noverify bool, db ethdb.Database) consensus.Engine {
	if chainConfig.BDLS != nil {
		return bdls_engine.New(ctx.AccountManager, ctx.EventMux, db)
	}
